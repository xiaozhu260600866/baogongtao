<template>
	<view>
		...
		<view v-if="data.show">
			<view class="cm-head ptb25 text-center main-bg">
			...
			<view class="cm-list">
				<view class="mb8 bg-f">
					<view class="weui-cell">
						...
						<view class="weui-cell__bd fs-15 fc-orange text-right">
				...
				<view class="mb8 bg-f">
					<view class="weui-cell">
						...
						<view class="weui-cell__bd fs-15 fc-3 text-right">
				...
				<view class="mb8 bg-f">
					<view class="weui-cell">
						...
						<view class="weui-cell__bd fs-12 fc-9 text-right">
			...
			<!-- <view id="footer-btn" @click="goto('/pages/distribution/domoney/main',1)">
