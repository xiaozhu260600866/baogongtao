	...
	<view>
		...
		<view class="tui-content">
			<view class="tui-form">
				...
				<view class="tui-title">实名认证成功</view>
				<view class="tui-sub-title">请继续前往签约，签约成功后即可领取任务</view>
				<view class="tui-btn-box">
					...
					<dx-button type="primary" :shadow="true" width="240rpx" height="70rpx" :size="28" shape="circle" @click="linkTo('/pages/user/sign/show',1)">前往签约</dx-button>
				</view>
			</view>
		</view>
	</view>
