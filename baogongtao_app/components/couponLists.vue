			...
			<view class="list_box" @click="linkTo('/pages/merchant/coupon/show/index?id='+v.id,1)">
				...
				<view class="item_right">
					...
					<!-- 	<view class="tips">{{v.getCoupon.abstract}}</view> -->
						...
						<view>距离<text class="Arial">1.3</text>千米</view>
					</view>
				</view>
			</view>
...
.cash-list .list_box{display: flex;flex: 1;}
...
.cash-list .item_right{position: relative;z-index: 2;padding: 20rpx 10rpx 20rpx 20rpx;flex: 1;min-height: 160rpx;display: flex;flex-direction: column;justify-content: space-between;}
...
.list_item3{margin-bottom: 0!important;padding: 30rpx 0;border-bottom: 1rpx #f5f5f5 solid;border-radius: 0;display: flex;}
