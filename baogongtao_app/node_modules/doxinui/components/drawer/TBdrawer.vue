<template>
	<view class="dxi-TBdrawer" :class="[visible ? 'dxi-TBdrawer-show' : '','dxi-TBdrawer-' + mode,myclass]" :style="{zIndex:zIndex}">
...
.dxi-TBdrawer-mask{opacity: 0;position: fixed;top: 0;left: 0;right: 0;bottom: 0;z-index: 98;background: rgba(0, 0, 0, 0.6);transition: all 0.3s ease-in-out;cursor: pointer;}
