<template>
	<form class="form" @submit="formType=='submit'?formSubmit() :''" :class="[block?'is-block':'',]">
		<button class="dxi-btn" :open-type="openType" :class="[type?'dxi-btn-'+type:'',size?'dxi-btn-'+size:'',round?'is-round':'',plain?'is-plain':'',selfDisabled?'is-disabled':'',fixed?'fixed':'',circle?'is-circle':'',hollow?'is-hollow':'',myclass,]" :disabled="selfDisabled" @tap="handleClick" @getphonenumber="bingGetPhoneNumber" @getuserinfo="bindgetuserinfo" :form-type="formType" :style="{backgroundColor:btnBg,borderColor:btnBd,}">
			<text :class="['iconfont',icon]" :style="{fontSize:iconSize,color:iconColor}" v-if="icon"></text>
			<text class="dxi-icon dxi-icon-loading icon-loading" :style="{fontSize:iconSize,color:iconColor}" v-if="loading"></text>
...
.dxi-btn{display: inline-flex;line-height: 1;white-space: nowrap;cursor: pointer;background: #fff;border: 1px solid #dcdfe6;color: #606266;-webkit-appearance: none;text-align: center;box-sizing: border-box;outline: none;margin: 0;transition: .1s;font-weight: 500;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;padding: 24upx 40upx;font-size: 30rpx;border-radius: 8upx;}
...
/* 大小 */
.dxi-btn-lg{padding: 30upx 40upx;font-size: 34rpx;border-radius: 10upx}
.dxi-btn-medium{padding: 20upx 40upx;font-size: 28rpx;border-radius: 8upx}
.dxi-btn-small{padding: 18upx 30upx;font-size: 26rpx;border-radius: 6upx}
.dxi-btn-mini{padding: 14upx 30upx;font-size: 24rpx;border-radius: 6upx}

/* 圆角大小 */
.dxi-btn.is-round{border-radius: 50upx;padding: 24upx 46upx;}
.dxi-btn-lg.is-round{padding: 30upx 40upx}
...
/* 圆圈按钮字体大小 */
.dxi-btn.is-circle .iconfont{margin-right: 0;font-size: 30rpx;display: flex;}
.dxi-btn-lg.is-circle .iconfont{font-size: 32rpx;}
.dxi-btn-small.is-circle .iconfont{font-size: 26rpx;}
.dxi-btn-mini.is-circle .iconfont{font-size: 24rpx;}
