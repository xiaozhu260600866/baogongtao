        ...
        <el-dialog :title="'选择产品' " :visible.sync="dialogVisible" :top="top" :before-close="handleClose">
            ...
            <el-col :span="19" style="margin-right: 10px;background: white;z-index: 999">
                ...
                <el-table ref="multipleTable"  :data="data.lists" border tooltip-effect="dark" v-loading="data.listLoading" style="width:100%" @selection-change="selsChange">
                    ...
                    <el-table-column prop="num" label="库存" min-width="60"> </el-table-column>
                    <el-table-column prop="c_price" label="成本价" width="100"> </el-table-column>
            ...
            <div class="toolbar" style='margin:50px 0' v-if="data.lists">
                <el-pagination @current-change="handleCurrentChange" :current-page="data.current_page" :page-sizes="[6]" :page-size="6" layout="total, sizes, prev, pager, next, jumper" :total="data.total" style='float: right'>
                </el-pagination>
            </div>
        </el-dialog>
    </section>
