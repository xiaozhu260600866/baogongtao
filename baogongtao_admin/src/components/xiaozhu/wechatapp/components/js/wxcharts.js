...
function calCategoriesData(categories, opts, config) {
    ...
    var _getXAxisPoints = getXAxisPoints(categories, opts, config)
        var eachSpacing = _getXAxisPoints.eachSpacing
...
function drawColumnDataPoints(series, opts, config, context) {
    ...
    var _calYAxisData = calYAxisData(series, opts, config)
        var ranges = _calYAxisData.ranges

    var _getXAxisPoints = getXAxisPoints(opts.categories, opts, config)
        var xAxisPoints = _getXAxisPoints.xAxisPoints
        var eachSpacing = _getXAxisPoints.eachSpacing
...
function drawAreaDataPoints(series, opts, config, context) {
    ...
    var _calYAxisData2 = calYAxisData(series, opts, config)
        var ranges = _calYAxisData2.ranges

    var _getXAxisPoints2 = getXAxisPoints(opts.categories, opts, config)
        var xAxisPoints = _getXAxisPoints2.xAxisPoints
        var eachSpacing = _getXAxisPoints2.eachSpacing
...
function drawLineDataPoints(series, opts, config, context) {
    ...
    var _calYAxisData3 = calYAxisData(series, opts, config)
        var ranges = _calYAxisData3.ranges

    var _getXAxisPoints3 = getXAxisPoints(opts.categories, opts, config)
        var xAxisPoints = _getXAxisPoints3.xAxisPoints
        var eachSpacing = _getXAxisPoints3.eachSpacing
...
function drawXAxis(categories, opts, config, context) {
    var _getXAxisPoints4 = getXAxisPoints(categories, opts, config)
        var xAxisPoints = _getXAxisPoints4.xAxisPoints
        var startX = _getXAxisPoints4.startX
        var endX = _getXAxisPoints4.endX
        var eachSpacing = _getXAxisPoints4.eachSpacing
...
function drawYAxis(series, opts, config, context) {
    ...
    var _calYAxisData4 = calYAxisData(series, opts, config)
        var rangesFormat = _calYAxisData4.rangesFormat
...
function drawLegend(series, opts, config, context) {
    ...
    var _calLegendData = calLegendData(series, opts, config)
        var legendList = _calLegendData.legendList
...
function drawCharts(type, opts, config, context) {
    ...
    var _calLegendData = calLegendData(series, opts, config)
        var legendHeight = _calLegendData.legendHeight

    config.legendHeight = legendHeight

    var _calYAxisData = calYAxisData(series, opts, config)
        var yAxisWidth = _calYAxisData.yAxisWidth

    config.yAxisWidth = yAxisWidth
    if (categories && categories.length) {
        var _calCategoriesData = calCategoriesData(categories, opts, config)
            var xAxisHeight = _calCategoriesData.xAxisHeight
            var angle = _calCategoriesData.angle
