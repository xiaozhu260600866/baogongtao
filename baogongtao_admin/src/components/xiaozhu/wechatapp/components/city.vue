<template>
  <div>
    <view class="input" style="padding-top:0">
      <view style="" @click="open">{{ province }}-{{ city }}-{{ county }}</view>
    </view>
    <view v-if="condition" class="citypicker">
      <picker-view indicator-style="height: 50px;" style="width: 100%; height: 300px;" :value="value" class="citybody" @change="bindChange">
        <view class="cityheader">
          <view class="city-cancel" @click="open">取消</view>
          <view class="city-true" @click="open">确定</view>
        </view>
        <picker-view-column>
