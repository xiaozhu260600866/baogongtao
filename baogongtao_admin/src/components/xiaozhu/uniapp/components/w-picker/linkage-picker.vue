  ...
  <view class="w-picker-view">
    <picker-view class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
      <picker-view-column v-for="(group,gIndex) in range" :key="gIndex">
        <view v-for="(item,index) in group" :key="index" class="w-picker-item">{{ item[nodeKey] }}</view>
      </picker-view-column>
    </picker-view>
  </view>
</template>
	...
	export default {
		...
		methods: {
			getData() {
				...
				const arr1 = options; let arr2 = []; let arr3 = []; let arr4 = []
				let col1Index = 0; let col2Index = 0; let col3Index = 0; let col4Index = 0
			...
			initData() {
				...
				const col1 = obj.col1; const col2 = obj.col2; const col3 = obj.col3 || {}; const col4 = obj.col4 || {}
			...
			handlerChange(e) {
				...
				const col1Index = arr[0]; const col2Index = arr[1]; const col3Index = arr[2] || 0; const col4Index = arr[3] || 0
				let arr1 = []; let arr2 = []; let arr3 = []; let arr4 = []
				let col1; let col2; let col3; let col4; let obj = {}
				let result = ''; let value = []
				arr1 = this.options
