  ...
  <section>
    <view class="page-head flex bg-f" :style="{height:height+'px',paddingTop:top+'px'}">
      <view class="head-icon flex mlr10">
        <p :class="['item', 'iconfont', pageHeadData.icon1.icon, pageHeadData.icon1.fontSize]" @click="goto(pageHeadData.icon1.url,pageHeadData.icon1.urlType)" />
        <p :class="['item', 'iconfont', pageHeadData.icon2.icon, pageHeadData.icon2.fontSize]" @click="goto(pageHeadData.icon2.url,pageHeadData.icon2.urlType)" />
      </view>
