<template>
	<section  class="bgf">
      ...
      <el-form :model="ruleForm" ref="ruleForm" lclass="demo-ruleForm" >
      <div class="flex">
            ...
            <div style="width: 300px;  background-color: rgba(255, 255, 255, 0.9);">
                <input type="file" id="change_btn" style="width: 80%; margin-top: 5%;display: block" @change="cut.fileChange('change_btn')" >
                按回车裁剪 
            </div>
        ...
        <div style="width:600px;height:600px">
            <h3>裁剪预览框</h3>
              <div class="btn btn-primary block col-sm-12 hidden" id="preview_btn" style="margin-top: 5%;" @click="cut.previewCutImg()">预览剪裁图片</div>
...
class CutContainer {
    ...
    createCut() {
        let styles = {
            ...
            h = document.getElementById("cut_container").style.height;
