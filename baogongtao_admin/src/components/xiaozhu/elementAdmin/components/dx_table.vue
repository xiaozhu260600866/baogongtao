<template>
  <div class="app-container">
            ...
            <div class="dx-container">
              <div class="dx-main">
                <div class="list-box" style="padding: 0;">
                  <new-class
                    v-if="data[listsClass.prop]"
                    :data="data[listsClass.prop]"
                    :fields="listsClass.classData"
                    :type="listsClass.classType"
                    :form-action="listsClass.classAction"
                    :class-children-hidden="false"
                    :add-lev="listsClass.addLev"
                    ...
                    <div class="flex1">
                      <el-form-item v-for="v in searchFields" :label="v.label">
                        ...
                        <div v-else-if="v.type == 'betweenDate'">
                          <el-date-picker
                            v-model="data.query[v.prop+'_start'] "
                            type="date"
                            :placeholder="v.placeholder ? v.placeholder :'选择'+v.label+'开始范围' "
                            value-format="yyyy-MM-dd"
                          />~
                          <el-date-picker
                            v-model="data.query[v.prop+'_end'] "
                            type="date"
                      ...
                      <el-form-item>
                        ...
                        <el-button
                          v-if="uploadData && uploadData.url"
                          type="success"
                          @click="upload"
                        >上传</el-button>
                        <el-form-item>
              ...
              <div class="list-box">
                ...
                >
                  ...
                  <el-table-column
                    ...
                    v-if="!v.hidden"
                    v-show="v['hidden_'+v.prop]? canShow(v):true"
                    :prop="v.prop"
                    :label="v.label"
                    :width="v.width"
                  ...
                  >
                    <template v-if="v.type || !v.type && v['append_table_'+v.prop]" scope="scope">
                      ...
                      <slot
                        v-if="!v.type && v['append_table_'+v.prop]"
                        :name="'append_table_'+v.prop"
                        :row="scope.row"
                        :$index="scope.$index"
                      />
                    </template>
                        ...
                        <el-dropdown>
                          ...
                          <el-dropdown-menu slot="dropdown">
                            ...
                            >
                              查看</el-dropdown-item>
                            <el-dropdown-item
                              v-if="scope.row.status!=1 && auditAction"
                              @click.native="changeStatus(scope.$index, scope.row,'1')"
                            >
                              审核通过
                            </el-dropdown-item>
                            <el-dropdown-item
                              v-if="scope.row.status!=2 && auditAction"
                ...
                <div class="list-bottom clearfix">
                  <div class="f-left flex">
                    <el-button
                      v-if="checkAll && canDel && !hiddenDelAll"
                      type="danger"
    ...
    <my-create-edit
      ...
      :create-edit-label="createEditLabel"
      :create-edit-diag-width="createEditDiagWidth"
      :length-diag="lengthDiag"
      @createBeforeCallBack="createBeforeCallBack"
    ...
    <new-class
      v-if="classAction && classFields.length"
      ref="category"
      :diag="true"
      :data="data.category"
      :fields="classFields"
      ...
      :class-children-hidden="classChildrenHidden"
      :canupload="canupload"
    >
    ...
    <new-class
      v-if="classAction &&classFields.length == 0"
      ref="category"
      :diag="true"
      :data="data.category"
      :add-lev="classLev"
