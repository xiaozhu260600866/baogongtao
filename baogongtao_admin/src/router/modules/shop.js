...
const shopRouter = {
    ...
    children: [
		{
        path: 'product/lists',
        component: () => import('@/views/shop/product/lists'),
        name: 'ProductLists',
        meta: { title: '产品管理', icon: 'dx-hr-info' }
    },
	{
	    ...
	    component: () => import('@/views/shop/product/lists'),
	    name: 'ProductLists',
	    meta: { title: '订单管理', icon: 'dx-hr-info' }
	},
	{
	    path: 'poster/lists',
	    component: () => import('@/views/shop/poster/lists'),
	    name: 'posterLists',
	    meta: { title: '广告管理', icon: 'dx-hr-info', params: { type: 1 }}
	}
