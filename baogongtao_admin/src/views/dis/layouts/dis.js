export default {
    data: {
        ...
        tableFields: [
            ...
            { label: '姓名', width: '150', append_table_name: false, prop: 'name', type: 'sort', 'url': '/admin/shop/dis/editField' },
            { label: '电话', width: '150', append_table_name: false, prop: 'phone', type: 'sort', 'url': '/admin/shop/dis/editField' },
