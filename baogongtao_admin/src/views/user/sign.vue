          ...
          <div class="dx-main">
            ...
            <div class="list-box">
              ...
              >
                ...
                <el-table-column label="电话" align="center" width="80">
                  <template slot-scope="scope">
                    {{ scope.row.getWork ? scope.row.getWork.phone :'' }}
                  </template>
                </el-table-column>
                <el-table-column label="身份证" align="center" width="80">
                  <template slot-scope="scope">
                    {{ scope.row.getWork ? scope.row.getWork.idcardno :'' }}
                  </template>
                </el-table-column>
                <el-table-column label="派注公司" align="center" width="80">
                  <template slot-scope="scope">
                ...
                <el-table-column label="上班打卡时间" align="center" width="80">
                  <template slot-scope="scope">
                    {{ scope.row.type == 0 ? scope.row.created_at : '' }}
                  </template>
                </el-table-column>
                <el-table-column label="下班打卡时间" align="center" width="80">
                  <template slot-scope="scope">
                    {{ scope.row.type == 1 ? scope.row.created_at : '' }}
                  </template>
                </el-table-column>
                <el-table-column label="外出打卡时间" align="center" width="80">
                  <template slot-scope="scope">
                    {{ scope.row.type == -1 ? scope.row.created_at : '' }}
                  </template>
                </el-table-column>
                <el-table-column label="外出打卡地点" align="center" width="80">
                  <template slot-scope="scope">
                ...
                <el-table-column label="外出打卡图片" align="center" width="80">
                  <template slot-scope="scope">
                    <a :href="getSiteName()+'/upload/images/sign/'+scope.row.cover" target="_blank"><img :src="getSiteName()+'/upload/images/sign/300_'+scope.row.cover" alt="" width="50"></a>
                  </template>
                </el-table-column>
