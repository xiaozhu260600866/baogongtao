	...
	<el-dialog title="新建\编辑" :visible.sync="dialogFormVisible" :top="top" :before-close="handleClose" width="800px">
		<el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm"
			...
			<el-form-item label="职位名称" prop="job_position" :rules="[{ required: true, message: '职位姓名'},]">
				<el-input v-model="ruleForm.job_position"  placeholder="职位姓名"></el-input>
			</el-form-item>
			...
			<el-form-item label="职位类型" prop="job_category" :rules="[{ required: true, message: '职位类型不能为空'},]">
				<el-cascader :options="positionCalss" v-model="ruleForm.job_category">
				</el-cascader>
			</el-form-item>
			<el-form-item label="薪资范围" prop="salary" :rules="[{ required: true, message: '职位类型不能为空'},]">
				<el-cascader :options="emolumentArr" v-model="ruleForm.salary">
				</el-cascader>
			</el-form-item>
			<el-form-item label="职位标签(福利待遇)" prop="job_tab" :rules="[{ required: true, message: '职位标签(福利待遇)不能为空'},]">
				<el-input v-model="ruleForm.job_tab" type="textarea" placeholder="以英文,号分隔"></el-input>
			</el-form-item>
			<el-form-item label="职位描述" prop="job_remark" :rules="[{ required: true, message: '职位描述'},]">
				<el-input v-model="ruleForm.job_remark" type="textarea" placeholder="职位描述"></el-input>
			</el-form-item>
			...
			<el-form-item label="年龄要求" prop="age" :rules="[{ required: true, message: '职位类型不能为空'},]">
				<el-cascader :options="ageArr" v-model="ruleForm.age">
				</el-cascader>
			</el-form-item>
			<el-form-item label="工作地址" prop="work_place">
				<div class="flex" style="display: flex;">
					<div  style="width:70%"><el-input v-model="ruleForm.work_place"></el-input></div>
					<div style="width:30%"><el-button @click.prevent="chooseLocation()">重新定位</el-button></div>
				</div>
			</el-form-item>
			<el-form-item label="联系人姓名" prop="contact_name" :rules="[{ required: true, message: '联系人姓名'},]">
				<el-input v-model="ruleForm.contact_name" type="textarea" placeholder="联系人姓名"></el-input>
			</el-form-item>
			<el-form-item label="联系人电话" prop="contact_phone" :rules="[{ required: true, message: '联系号码'},]">
				<el-input v-model="ruleForm.contact_phone" type="textarea" placeholder="联系号码"></el-input>
			</el-form-item>
