                ...
                <el-row>
                  ...
                  <el-col :span="24">
                    <el-form-item label="所在地" prop="province">
                      <v-distpicker :province="formData.province" :city="formData.city" :area="formData.area" @selected="selectedPca" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                  ...
                  <el-col :span="8">
                    <el-form-item label="LOGO">
                      <tyt-upload :length="1" :file-list="formData.logoArr" path-name="logo" :thumbsize="[300]" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="营业执照">
                      <tyt-upload :length="1" :file-list="formData.licenseArr" path-name="logo" :thumbsize="[300]" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item label="法人身份证">
                      <tyt-upload :length="1" :file-list="formData.idcardArr" path-name="logo" :thumbsize="[300]" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
                    <el-form-item label="企业资质">
                      <tyt-upload :length="5" :file-list="formData.credentialsArr" path-name="logo" :thumbsize="[300]" />
                    </el-form-item>
                  </el-col>
          ...
          <div class="dx-container mt5">
            ...
            <div class="dx-main">
              <div class="list-box mt20">
                ...
                <el-row>
                  <el-col :xs="24" :sm="12" :lg="8">
                    <el-form-item label="登录账号" prop="username" :rules="[{ required: true, message: '请输入企业登录账号'}]">
                      <el-input v-model="formData.username" />
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="12" :lg="8">
                    <el-form-item label="登录密码" prop="password" :rules="[{ required: true, message: '请输入企业登录密码'}]">
                      <el-input v-model="formData.password" type="password" :show-password="true" />
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="12" :lg="8">
                    <el-form-item label="账号状态" prop="account_status">
                      <el-switch v-model="formData.account_status" :active-value="1" :inactive-value="0" active-text="" inactive-text="" />
                    </el-form-item>
                  </el-col>
                </el-row>
...
<script>
import { classes, detail, store } from '@/api/company'
import TytUpload from '@/components/Tytrock/components/UploadImg'
import Tinymce from '@/components/Tinymce'
import VDistpicker from 'v-distpicker'
export default {
	name: 'CompanyCreate',
	components: { TytUpload, Tinymce, VDistpicker },
	data() {
		return {
			pageTitle: '新增企业',
			...
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					store(this.formData).then(res => {
						...
						this.$router.push({ path: '/company/show?id=' + res.data.data.id })
					})
				} else {
