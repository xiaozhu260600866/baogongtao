					...
					<div class="dx-main">
						...
						<div class="list-box">
							<el-table v-loading="listsData.listLoading" :data="listsData.data" border style="width: 100%" @sort-change="sortAction" @selection-change="selsChange">
								...
								<el-table-column prop="job_type" label="招聘类型" align="center" width="80" />
								...
								<el-table-column prop="salary" label="薪资范围" align="center" width="80" />
								<el-table-column prop="job_tab" label="职位标签(福利待遇)" align="center" width="100" />
								<el-table-column prop="job_remark" label="职位描述" align="center" min-width="100" />
								<el-table-column prop="education" label="工作经验" align="center" width="80" />
								<el-table-column prop="age" label="年龄要求" align="center" width="80" />
								...
								<el-table-column prop="contact_name" label="联系人姓名" align="center" width="80" />
