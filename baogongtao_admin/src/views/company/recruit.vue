<template>
	<div class="app-container">
										...
										<el-dropdown >
											...
											<el-dropdown-menu slot="dropdown">
												...
												<el-dropdown-item  class="fc-danger" @click.native="edit(scope.row)">
													<i class="el-icon-edit" /> 修改</el-dropdown-item>
											</el-dropdown-menu>
										</el-dropdown>
									</template>
								</el-table-column>
		...
		<recruitCreateEdit ref="recruitCreateEdit"></recruitCreateEdit>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			del(index,item){
				this.handleCommand({command:"delete",row:item,index:index});
			},
			edit(item) {
