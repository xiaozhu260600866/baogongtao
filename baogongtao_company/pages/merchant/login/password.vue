	...
	<view>
		...
		<view class="info-form zindex2">
			<view class="bg-f">
				...
				<weui-input v-model="ruleform.code" label="验证码" datatype="require" type="sms" name="sms" :phone="ruleform.phone" action="/sendSms.html" navClass="dxi-btn-primary dxi-btn"></weui-input>
				<weui-input v-model="ruleform.loginPassword" label="密码" type="password" name="loginPassword"></weui-input>
			</view>
			<view class="m20 info-subBtn"><dx-button type="primary" size="lg" block @click="submit"> 完成</dx-button></view>
			<view class="text-center fs-15 fc-3 mt30" @click="goto('/pages/merchant/login/index')">立即登录</view>
		</view>
	</view>
</template>
